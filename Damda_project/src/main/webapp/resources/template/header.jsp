<%@ page language="java" contentType="text/html; charset=UTF-8"
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu menu_control" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="/mypage/userinfo">개인정보</a></li>
                            </ul>
                        </li>
                        <%}else if(user_ctg == 1){  %>
                        <li class="dropdown">
	...
	<div class="modal" id="logoutModal" style="display:none; z-index: 1050;">
	        ...
	        <div class="modal-content">
	            <div class="modal-body text-center" id="confirmMessage">
		            ...
		            <div class="modal-footer">
		                <button type="submit" class="btn btn-default" id="logoutOk">확인</button>
		                <button type="button" class="btn btn-default" id="logoutCancel">취소</button>
		            </div>
		            </form>
	       	 	</div>
	    	</div>
        ...
        <div id="content" class="col-md-12">
			<div class="text-right col-md-12 col-sm-12 col-xs-12">
				<a id="MOVE_TOP_BTN" href="#">
					<img src="/resources/icon/top.png" />
					<p>Top</p>
				</a>
			</div>